...
export const PasswordResetEmail = ({
  ...
  const previewText = 'Reset your TeamFlow password';
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            We received a request to reset your password for your TeamFlow account. Click the
          ...
          <Text style={footer}>
            This link will expire in <strong>{expiryMinutes} minutes</strong>. If you didn't
